---
name: b7s-daily-dump
description: Alias de `b7s-brainstorm` — daily dump freestyle del día. Úsala cuando el usuario diga "daily dump", "voy a hacer mi daily", "necesito mi dump del día".
